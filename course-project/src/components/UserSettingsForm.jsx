...
<<<<<<< HEAD:course-project/src/components/UserSettingsForm.jsx
  useEffect(() => {
    getAllClassesData();
    getInterestsList();
=======
  ...
  useEffect(() => {
    getAllClassesData();
>>>>>>> 59a8f13 (refactor: Relocate API hooks to a dedicated directory, update components for new data fetching patterns, and connected the all classes api to display in the user settings and the homepage):course-project/src/Components/UserSettingsForm.jsx
